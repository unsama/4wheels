            ...
            <div class="banner tc-light">
                <div class="banner-block">
                    ...
                    <div class="bg-image change-bg">
                        <img src="{{URL::asset('images/banner-sm-g.jpg')}}" alt="Wordpress" width="100%" height="100%" title="Wordpress" loading="lazy">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-md-6">
                    <div class="section-head section-md">
                        <div class="text-box">
                            <p class="lead">At Megapixel Technologies, we enjoy creating specialized themes. We create a WordPress website for you that is tailored to your needs. If you want to modify an existing theme or develop a completely new one, we can help. Need more? Check our wordpress website design packages now!</p>
                        </div>
                    </div>
                </div><!-- .col -->
            </div><!-- .row -->
