...
<head>
    ...
    <!-- Site Title  -->
    <title>Megapixel Technologies | UI UX Design Services - Web Mobile Design</title>
    <meta name="description"
        content="A great website requires modern UI UX design services for web & mobile. Elegant & beautiful design for your website.">
    <link rel="canonical" href="https://megapixeltech.com/services/graphic-design-services/ui-ux-design-services" />
    <meta name="robots" content="index, follow" />
       <!-- Twitter Card data -->
       <meta name="twitter:card" content="summary_large_image"/>
       <meta name="twitter:title" content="Megapixel Technologies | UI UX Design Services - Web Mobile Design"/>
       <meta name="twitter:description" content="A great website requires modern UI UX design services for web & mobile. Elegant & beautiful design for your website."/>
    ...
    <!-- Open Graph data -->
    <meta property="og:title" content="Megapixel Technologies | UI UX Design Services - Web Mobile Design " />
                        ...
                        <div class="row ">
                            <div class="col-md-10 col-xl-7 offset-xl-0">
                                <div class="banner-content">
                                    <h1 class="banner-heading">UI/UX</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="bg-image change-bg">
                        <img src="{{URL::asset('images/banner-sm-g.jpg')}}" alt="UI/UX" title="UI/UX" loading="lazy" width="100%" height="100%">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between">
                <div class="col-md-5">
                    <div class="section-head section-md res-m-btm">
                        <h5 class="heading-xs dash">UI/UX</h5>
